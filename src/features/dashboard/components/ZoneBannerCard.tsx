...
export const ZoneBannerCard: React.FC<ZoneBannerCardProps> = ({
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden shadow-lg h-full min-h-50">
      ...
      {/* Icon Thời tiết (Có thể thu nhỏ lại một chút để nhường chỗ cho text) */}
      ...
      {/* Thông tin Khu vực ở dưới cùng */}
      <div className="absolute bottom-2 left-6 right-6">
        <h1 className="text-white text-4xl lg:text-5xl font-extrabold tracking-tight drop-shadow-lg leading-tight">
          {zoneName}
        </h1>
      </div>
    </div>
