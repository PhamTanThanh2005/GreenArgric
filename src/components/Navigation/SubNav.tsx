...
export const SubNav: React.FC = () => {
  ...
  const getCurrentPageName = () => {
    ...
    if (path.includes('/admin/thresholds')) return 'Thiết lập Ngưỡng';
      ...
      {role !== 'admin' && (
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-4 py-1.5 rounded-lg text-sm font-bold transition-colors cursor-pointer",
              isDropdownOpen 
                ...
                areas.map((zone) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "w-full text-left px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-50 cursor-pointer",
